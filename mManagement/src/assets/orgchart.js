...
(OrgChart._defaultConfig = function (t) {
        ...
        for (var t = "", r = 0; r < l.length; r++) {
          ...
          if (Array.isArray(i)) {
            ...
            !OrgChart.isNEU(s.id) &&
              ...
              OrgChart.isNEU(s.value) &&
              (n = s.id),
              OrgChart.isNEU(s.value) || A.push(`${i.label}: ${s.value}`),
              (t += s.html);
          }
        }
        return t;
      ...
      (this.obj = t),
        ...
        e.layout &&
          ...
          (this.layouts.innerHTML =
            ...
            OrgChart.attr.layout +
            '="treeLeftOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="30" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="30" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="85" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="85" x2="85" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="40" x2="85" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="40" x2="85" y1="54" y2="54" stroke-width="1"></line></svg><svg ' +
            OrgChart.attr.layout +
  ...
  (OrgChart.templates.base = {
    ...
    img_0:
      '<clipPath id="{randId}"><circle cx="60" cy="60" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="20" y="20"  width="40" height="40"></image>',
    link_field_0:
      '<text text-anchor="middle" fill="#aeaeae" ' +
      OrgChart.attr.width +
      '="290" x="0" y="0" style="font-size:10px;">{val}</text>',
    editFormHeaderColor: "#f8f8f9",
  }),
  (OrgChart.templates.ana = {
    ...
    plus: '<circle cx="15" cy="15" r="15" class="boc-fill" stroke="#aeaeae" stroke-width="1">25</circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#aeaeae"></line>',
    minus:
    ...
    img_0:
      '<clipPath id="{randId}"><circle cx="50" cy="30" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="10" y="-10"  width="40" height="40"></image>',
    link_field_0:
      '<text text-anchor="middle" fill="#aeaeae" ' +
      OrgChart.attr.width +
      '="290" x="0" y="0" style="font-size:10px;">{val}</text>',
  ...
  (OrgChart.templates.ula.img_0 =
    '<clipPath id="{randId}"><circle cx="50" cy="60" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="10" y="20" width="40" height="40" ></image>'),
  ...
  (OrgChart.templates.belinda.img_0 =
    '<clipPath id="{randId}"><circle cx="90" cy="45" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="50" y="5" width="40" height="40" ></image>'),
  ...
  (OrgChart.templates.rony.field_2 =
    "<text " +
    OrgChart.attr.width +
    '="165" style="font-size: 14px;" fill="#FFCA28" x="90" y="40" text-anchor="middle">{val}</text>'),
  ...
  (OrgChart.templates.polina.node =
    '<rect x="0" y="0" height="40" width="300" fill="#039BE5" stroke-width="1" stroke="#686868" rx="40" ry="40"></rect>'),
  (OrgChart.templates.polina.img_0 =
    '<clipPath id="{randId}"><circle  cx="40" cy="40" r="35"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="0" y="0"  width="40" height="40"></image>'),
  (OrgChart.templates.polina.field_0 =
    "<text " +
    OrgChart.attr.width +
    '="210" style="font-size: 18px;" fill="#ffffff" x="40" y="30" text-anchor="start">{val}</text>'),
  (OrgChart.templates.polina.field_1 =
    "<text " +
    OrgChart.attr.width +
    '="210" style="font-size: 14px;" fill="#ffffff" x="40" y="55" text-anchor="start">{val}</text>'),
  ...
  (OrgChart.templates.mila.node =
    '<rect x="0" y="0" height="120" width="250" fill="#f8f8f9" stroke-width="1" stroke="#aeaeae"></rect><rect x="-5" y="70" height="30" width="260" fill="#ffffff" stroke-width="1" stroke="#039BE5"></rect><line x1="-5" x2="0" y1="100" y2="105" stroke-width="1" stroke="#039BE5"/><line x1="255" x2="250" y1="100" y2="105" stroke-width="1" stroke="#039BE5"/>'),
  ...
  (OrgChart.templates.diva.node =
    '<rect x="0" y="40" height="90" width="200" fill="#039BE5"></rect><circle cx="100" cy="50" fill="#ffffff" r="50" stroke="#039BE5" stroke-width="2"></circle>'),
  ...
  (OrgChart.templates.luba.img_0 =
    '<clipPath id="{randId}"><circle cx="50" cy="25" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="10" y="-15"  width="40" height="40"></image>'),
    ...
    link: function (t, e, r, i, a, n, o) {
      ...
      for (C = 0; C < t.children.length; C++) {
        ...
        OrgChart.events.publish("render-link", [e, A]),
          d.push(A.html),
          o && c.push({ id: t.id, childId: O.id, html: A.html });
        var N = "";
  ...
  (OrgChart.pdfPrevUI.show = function (t, e) {
    ...
    r.classList.add(t.config.mode),
      ...
      (r.innerHTML =
        ...
        '</option><option value="10">10%</option><option value="20">20%</option><option value="30">30%</option><option value="40">40%</option><option value="50">50%</option><option value="60">60%</option><option value="70">70%</option><option value="40">80%</option><option value="90">90%</option><option value="100">100%</option><option value="110">110%</option><option value="120">120%</option><option value="130">130%</option><option value="140">140%</option><option value="150">150%</option><option value="160">160%</option><option value="170">170%</option><option value="180">180%</option><option value="190">190%</option><option value="200">200%</option></select></div><div style="margin-top:10px;margin-bottom:10px; height:10px;border-bottom:1px solid #eeeeee;"></div><div style="padding-top:10px;"><label for="boc-ppdf-header">' +
